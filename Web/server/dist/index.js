...
function initializeChart() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            console.log("Fetching data for time range:", exports.startTime, "to", exports.endTime);
            const data = yield (0, chart_1.fetchQuakeData)(exports.startTime, exports.endTime);
